...
<body>
	<div class="container">
		...
		<div class="main-content">
			<h1 class="h1">WE ARE GROWING AND EXPANDING <br> JOIN US NOW!</h1>
			<span class="span">
				We are now actively looking for people to join us. You'll will have an oportunity to gain profit and spread
				health awereness all over the world. We do also accept new members in our organization, Filipino’s not only here in the Philippines but throughout the world.
				<br><br>
				Fill up this form and Submit. We'll be waiting for you :)
			</span>
			<div class="content">
				<form action="mail.php" method="post">
					<div class="form-group">
				    	<label for="inputEmail">FULLNAME</label>
				        <input class="form-control" id="inputEmail" placeholder="Last Name" type="text" name="last_name">
				       	<input class="form-control" id="inputEmail" placeholder="First Name" type="text" name="first_name">
				       	<input class="form-control" id="inputEmail" placeholder="Middle Name" type="text" name="middle_name">
				    </div>
				    <div class="form-group">
				    	<label for="inputEmail">SPOUSE FULLNAME</label>
				        <input class="form-control" id="inputEmail" placeholder="Last Name" type="text" name="s_last_name">
				       	<input class="form-control" id="inputEmail" placeholder="First Name" type="text" name="s_first_name">
				       	<input class="form-control" id="inputEmail" placeholder="Middle Name" type="text" name="s_middle_name">
				    </div>
				    <div class="form-group">
				    ...
				    <div class="form-group">
				        ...
				        <input class="form-control" id="inputEmail" placeholder="Zipcode" type="text" name="zipcode">
